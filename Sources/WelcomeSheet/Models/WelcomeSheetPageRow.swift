...
public struct WelcomeSheetPageRow: Identifiable, Decodable {
    ...
    public var content: LocalizedStringKey
    ...
    public init(image: Image, accentColor: Color? = nil, title: LocalizedStringKey, content: LocalizedStringKey) {
        self.image = image
    ...
    public init(imageSystemName: String, accentColor: Color?, title: LocalizedStringKey, content: LocalizedStringKey) {
    ...
    public init(imageNamed: String, accentColor: Color?, title: LocalizedStringKey, content: LocalizedStringKey) {
    ...
    public init(uiImage: UIImage, accentUIColor: UIColor? = nil, title: LocalizedStringKey, content: LocalizedStringKey) {
    ...
    /// Creates Welcome Sheet page row with system image, given title and content. Tints image with specified colour.
    public init(imageSystemName: String, accentUIColor: UIColor?, title: LocalizedStringKey, content: LocalizedStringKey) {
        self.init(image: Image(systemName: imageSystemName), accentColor: accentUIColor?.toColor(), title: title, content: content)
    }

    /// Creates Welcome Sheet page row with image name, given title and content. Tints image with specified colour.
    public init(imageNamed: String, accentUIColor: UIColor?, title: LocalizedStringKey, content: LocalizedStringKey) {
    ...
    /// Creates Welcome Sheet page row with system image, given title and content. Tints image with specified colour.
    public init(imageSystemName: String, title: LocalizedStringKey, content: LocalizedStringKey) {
        self.init(image: Image(systemName: imageSystemName), title: title, content: content)
    }

    /// Creates Welcome Sheet page row with image name, given title and content. Tints image with specified colour.
    public init(imageNamed: String, title: LocalizedStringKey, content: LocalizedStringKey) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        content = try LocalizedStringKey(container.decode(String.self, forKey: .content))
